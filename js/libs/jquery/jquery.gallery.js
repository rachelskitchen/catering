    ...
    $.fn.gallery = function(opts) {
        ...
        this.each(function(i) {
            ...
            if (typeof opts.onScroll == 'function') {
                $.data(this, 'gallery-onScroll', opts.onScroll);
            }
            ...
            } else if (Array.isArray(opts.images) && opts.images.length) {
                createGallery();
            }
            ...
            function createGallery() {
                ...
                $.data(self, 'gallery-scroll', scroll);
                ...
                function scroll(m) {
                    ...
                    controlButtons();
                    $.data(self, 'gallery-current-index', curIndex);

                    var onScrollHandler = $.data(self, 'gallery-onScroll');
                    typeof onScrollHandler == 'function' && onScrollHandler.call(self, curIndex);
                }
