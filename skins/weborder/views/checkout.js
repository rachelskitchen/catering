...
define(["checkout_view"], function(checkout_view) {
    ...
    var CheckoutPageView = App.Views.FactoryView.extend({
        ...
        bindings: {
            ...
            '.stanford-card-box': 'classes: {hide: any(not(equal(paymentMethods_selected, "stanford")), not(hasGrandTotal(total_grandTotal)))}',
            '.stanford-plans-box': 'classes: {hide: any(not(equal(paymentMethods_selected, "stanford")), not(hasGrandTotal(total_grandTotal)))}',
