    ...
    $.fn.combobox = function() {
    	...
    	this.each(function(){
	        ...
	        if(originalSelect[0].tagName.toUpperCase()==="SELECT"){
	        	...
	        	wrapper.addClass("combobox");

	        	//place an input which will represent the editable select
	        	var inputSelect = $("<input/>").attr("maxlength", 3).insertBefore(originalSelect);
	        	...
	        	var rightPadding = 15;
	        	inputSelect.addClass("inputbox");/*.css({
	        	...
	        	var triangle = $("<div/>").addClass("triangle")/*css({
	        		height: 0, width: 0,
	        	...
	        	var selectList = $("<ol/>").addClass("selectbox").css({
	        		//display: "none",
	        		//listStyleType: "none",
