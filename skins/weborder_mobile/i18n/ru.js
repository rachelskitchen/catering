define(function() {
    return {
        ...
        'CHECKOUT_REWARD_CARD_NUMBER':     'Накопительная карта №',
        ...
        'STORE_INFO_CHANGE_STORE':         'Изменить расположение магазина?',
